...
GENDATA="$WAS_ROOT/Tests/Intra-Node Application_Benchmark/ML_training/gen_data.py"
GENMODEL="$WAS_ROOT/Tests/Intra-Node Application_Benchmark/ML_inference/gen_model.py"
