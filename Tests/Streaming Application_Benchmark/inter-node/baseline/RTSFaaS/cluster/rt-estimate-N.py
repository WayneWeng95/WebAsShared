...
NODES_ALL = [("10.10.1.1","node-1-link-0"), ("10.10.1.3","node-3-link-0"),
             ("10.10.1.4","node-2-link-0"), ("10.10.1.5","node-7-link-0"),
             ("10.10.1.6","node-6-link-0"), ("10.10.1.7","node-5-link-0"),
             ("10.10.1.8","node-4-link-0"), ("10.10.1.9","node-8-link-0")]
import os
_N = int(os.environ.get("RT_NODES", "8"))
NODES = NODES_ALL[:_N]
