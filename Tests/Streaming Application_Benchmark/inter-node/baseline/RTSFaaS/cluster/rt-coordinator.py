...
def one_run(app, env, coord, workers, port, rtdir, reps_idx, total):
    ...
    for n in nodes:
        call(n, port, "/rm", {})
    return res, client_log, driver_log
...
def main():
    ...
    for app in apps:
        ...
        for r in range(1, args.reps + 1):
            res, clog, dlog = one_run(app, env, coord, workers, port, rtdir, r, args.reps)
