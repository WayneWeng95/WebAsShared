...
LABEL = {4096: "4 KiB page (engine)", 65536: "64 KiB page", 2097152: "2 MiB page"}
...
COMP = "shm-zerocopy"
COMP_LABEL = "Shared memory (zero-copy)"
COMP_COLOR = "#1d7a3e"
COMP_MARKER = "*"
...
def main():
    ...
    ap.add_argument("--row", choices=["copy", "zerocopy"], default="copy",
